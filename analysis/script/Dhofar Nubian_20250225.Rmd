...
set.seed(132)
setwd("") # Set your working directory. In order for the ggsave feature to work, you must have a sub-folder in your working directory called "Figures" and within this two sub-folders called "MS" (which stores figures from the main text) and "SI" (which stores figures from the supplementary information).
...
df = read_csv("DN_Database_20250225.csv")
df_filtered <- df %>%
  filter() %>%
